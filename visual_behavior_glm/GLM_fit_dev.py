...
if False:  # Code snippets for doing analyses.
    ...
    inventory17 = gat.inventory_glm_version(
        '17_dff_all_L2_optimize_by_session')
    ...
    comparison_table, results_combined = gat.get_glm_version_comparison_table(
        versions)
    ...
    rc['over_fit'] = rc.apply(
        lambda x: (
            x['Full__avg_cv_var_train'] - x['Full__avg_cv_var_test']) / (
            x['Full__avg_cv_var_train']),
        axis=1)
    ...
    gvt.plot_dropout_individual_population(
    ...
    gvt.plot_population_averages_by_depth(
    ...
    gvt.plot_coding_fraction(
        results_pivoted,
        run_params,
        'omissions')  # Example
    gvt.plot_all_coding_fraction(
        results_pivoted,
        run_params,
        metric='fraction')
    ...
    gvt.plot_fraction_summary_population(
        results_pivoted,
        run_params,
        kernel_excitation=True,
        kernel='omissions')
    gvt.plot_population_averages(
        results_pivoted,
        run_params,
        dropouts_to_show=[
            ...
            'omissions_positive',
            'omissions_negative'])
    stats = gvt.plot_population_averages_by_area(
        results_pivoted,
        run_params,
        dropouts_to_show=[
            'omissions',
            'omissions_positive',
            'omissions_negative'],
        extra='_omissions_excitation')
    stats = gvt.plot_population_averages_by_depth(
        results_pivoted,
        run_params,
        dropouts_to_show=[
            'omissions',
    ...
    gvt.plot_population_averages(
        ...
        dropouts_to_show=[
            ...
            'all-images_negative'])
    gvt.plot_kernel_comparison_by_kernel_excitation(
        weights_df, run_params, 'hits')
    gvt.plot_kernel_comparison_by_kernel_excitation(
        weights_df, run_params, 'misses')
    gvt.plot_kernel_comparison_by_kernel_excitation(
        weights_df, run_params, 'task')
    gvt.plot_kernel_comparison_by_kernel_excitation(
        weights_df, run_params, 'all-images')
    gvt.plot_fraction_summary_population(
        results_pivoted,
        run_params,
        kernel_excitation=True,
    ...
    stats = gvt.plot_population_averages_by_area(
        results_pivoted, run_params, dropouts_to_show=[
            'hits', 'hits_positive', 'hits_negative'], extra='_hits_excitation')
    stats = gvt.plot_population_averages_by_area(
        results_pivoted,
        run_params,
        dropouts_to_show=[
            ...
            'misses_positive',
            'misses_negative'],
        extra='_misses_excitation')
    stats = gvt.plot_population_averages_by_area(
        results_pivoted, run_params, dropouts_to_show=[
            'task', 'task_positive', 'task_negative'], extra='_task_excitation')
    stats = gvt.plot_population_averages_by_area(
        results_pivoted,
        run_params,
        dropouts_to_show=[
    ...
    data, score_df = gas.across_session_normalization(
        cell_specimen_id, version)
    ...
    vip_proportion_table, vip_stats_table = gc.final(
        cluster_df, 'Vip-IRES-Cre')
    sst_proportion_table, sst_stats_table = gc.final(
        cluster_df, 'Sst-IRES-Cre')
    exc_proportion_table, exc_stats_table = gc.final(
        cluster_df, 'Slc17a7-IRES2-Cre')
...
def make_baseline_figures(
    ...
    if run_params is None:
        print('loading data')
        run_params, results, results_pivoted, weights_df, full_results = get_analysis_dfs(
            VERSION)
        print('making figues')
    ...
    gvt.plot_all_kernel_comparison(
        ...
        plot_errors=False)
    gvt.plot_all_kernel_comparison(
        weights_df, run_params, compare=[
            'cre_line', 'layer'], plot_errors=False)


def dev_ignore():
    gvt.plot_all_kernel_comparison(
        weights_beh, run_params, compare=[
            'cre_line', 'strategy'], plot_errors=False)
    gvt.plot_all_kernel_comparison(
        weights_beh,
        run_params,
        cell_filter='vip',
    ...
    gvt.plot_all_kernel_comparison(
        ...
        plot_errors=False)
    gvt.plot_all_kernel_comparison(
        weights_beh, run_params, cell_filter='vip', compare=[
            'strategy', 'layer'], plot_errors=False)
    gvt.plot_all_kernel_comparison(
        weights_beh, run_params, cell_filter='sst', compare=[
            'strategy', 'layer'], plot_errors=False)
    gvt.plot_all_kernel_comparison(
        weights_beh, run_params, cell_filter='slc', compare=[
            'strategy', 'layer'], plot_errors=False)
