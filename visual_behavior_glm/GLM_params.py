...
def define_kernels():
    kernels = {
        ...
        'each-image':   {'event':'each-image',  'type':'discrete',      'length':0.5,   'offset':0,     'dropout':True, 'text': 'image presentation'},
        'image_expectation':   {'event':'image_expectation','type':'discrete','length':0.25, 'offset':-0.25,'dropout':True, 'text': '750ms from last image'},
