...
def plot_dropout_summary(results_summary, cell_specimen_id, ax, 
        ...
        ylabel_fontsize=22, ticklabel_fontsize=21, title_fontsize=22, legend_fontsize=20):
    '''
    ...
    colors = ['black','gray']
    for ii, ytick in enumerate(ax.get_yticks()):
        ax.axhspan(ytick-0.5, ytick+0.5, color=colors[ii%2], alpha=0.25)
