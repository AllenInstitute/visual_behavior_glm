...
VERSION = '58_medepalli_vip_omissions_specific'
print('\nVersion Specified: {}!\n'.format(VERSION))
...
# VERSION2 = '58_medepalli_vip_non_omissions_specific'
...
# the dropout score
# stats_D = gvt.plot_dropout_summary_population(results, run_params, dropouts_to_show=['all-images', 'all-omissions', 'behavioral', 'task'], cre_lines=['Vip-IRES-Cre'], savefig=True) 
# print('\nPanel D Complete!\n')
print('\nSkipping Panel D...\n')
...
## S5 - Depth V1
# stats_S5_V1 = gvt.plot_population_averages_by_depth(results_pivoted,run_params, area='VISp') 


## S5 - Depth LM
# stats_S5_LM = gvt.plot_population_averages_by_depth(results_pivoted,run_params, area='VISl')   
...
# Returns a dataframe with rows for cre/experience, and columns with the fraction of
# cells coding for each regressor, and the CI value (which is the value +/- from the mean)
# stats_S10B = gvt.plot_fraction_summary_population(results_pivoted, run_params, kernel_excitation=True,kernel='omissions')
