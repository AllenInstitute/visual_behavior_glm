...
exc_change = psth.load_change_df(
    summary_df,
    ...
    image=True,
    meso=True)
psth.plot_summary_bootstrap_strategy_hit(
    exc_change,
    'exc',
    first=False,
    second=False,
...
sst_change = psth.load_change_df(summary_df, cre='Sst-IRES-Cre', data='events',
                                 first=False, second=True, meso=True)
psth.plot_summary_bootstrap_strategy_hit(
    sst_change, 'sst', first=False, second=True, meso=True)
...
bootstraps_omission = psth.get_running_bootstraps(
    'vip', 'omission', 'events', 10000, meso=True)
psth.running_responses(
    vip_omission,
    'omission',
...
exc_change = psth.load_change_df(
    ...
    cre='Slc17a7-IRES2-Cre',
    data='events')
psth.plot_summary_bootstrap_strategy_engaged_miss(
    exc_change,
    cell_type='exc',
    first=False,
    second=False,
...
psth.plot_summary_bootstrap_strategy_engaged_omission(
    exc_post,
    data='events',
    nboots=10000,
    cell_type='exc',
...
vip_image = psth.load_image_df(summary_df, cre='Vip-IRES-Cre', data='events',
                               second=True, meso=True)
boot_image_visual = psth.compute_engagement_running_bootstrap(
    vip_image, 'image', 'vip', 'visual', nboots=10000, meso=True, second=True)
boot_image_timing = psth.compute_engagement_running_bootstrap(
    vip_image, 'image', 'vip', 'timing', nboots=10000, meso=True, second=True)
...
vip_omission = psth.load_omission_df(
    ...
    data='events',
    meso=True)
boot_omission_visual = psth.compute_engagement_running_bootstrap(
    vip_omission, 'omission', 'vip', 'visual', nboots=10000, meso=True, compute=False)
boot_omission_timing = psth.compute_engagement_running_bootstrap(
    vip_omission, 'omission', 'vip', 'timing', nboots=10000, meso=True, compute=False)
...
# Novelty Supplement
##########################################################################
dfs_novel = psth.get_figure_4_psth(
    data='events',
